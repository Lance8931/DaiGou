...
public class ProductionController {
	...
	public InfoResult putProduction(@PathVariable(name = "id", required = true) Long id,
		...
		Production productionEdit = productionService.findProductionById(id);
		if (productionEdit.getBuyPrice() != production.getBuyPrice()) {
			PriceChangeLog log = new PriceChangeLog(production.getBuyPrice(), id);
			priceChangeLogService.save(log);
		}
	...
	@ResponseBody
	public InfoResult uploadPhoto(@PathVariable(name = "id", required = true) Long proId, MultipartFile photos,
